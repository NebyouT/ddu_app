...
class FriendsModel {
  Rx<List<TwitterItemModel>> twitterItemList = Rx([
    TwitterItemModel(twitter: ImageConstant.imgTwitterBlue500.obs),
    TwitterItemModel(twitter: ImageConstant.imgFacebookBlueA400.obs),
    TwitterItemModel(twitter: ImageConstant.imgSnapchat.obs)
  ]);
